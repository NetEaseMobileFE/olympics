...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stack = __webpack_require__(159);
	...
	var ready = false;
	var debugContainer = void 0;
	var render = function render() {
		if (ready) ReactDOM.render(React.createElement(_layout2.default, { stack: _stack2.default }), debugContainer);
	};

	var index = 0; //react需要一个key
	window.console.log = function (msg) {
		_stack2.default.store.push({ key: index++, msg: msg });
		render();
	};

	window.console.clear = function () {
		_stack2.default.store = [];
		render();
	};
	...
	timer = setInterval(function () {
		if (document.body) {
			...
			debugContainer.className = "__debugger__";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Layout = _react2.default.createClass({
		...
		render: function render() {
			...
			var className = "wrap " + (this.state.show ? 'show' : 'hide');
			if (this.state.show) return _react2.default.createElement(
				...
				_react2.default.createElement(_messages2.default, { stack: stack }),
				_react2.default.createElement(_input2.default, null)
			);else return _react2.default.createElement(
				'div',
				{ className: 'expand', onClick: this.show },
				'+'
			);
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Messages = React.createClass({
		...
		render: function render() {
			var stack = this.props.stack.store.map(function (_ref) {
				var msg = _ref.msg;
				var key = _ref.key;

				return React.createElement(_message2.default, { key: key, value: msg });
			});
		...
		render: function render() {
			...
			switch (typeof val === 'undefined' ? 'undefined' : _typeof(val)) {
				case 'string':
					return React.createElement(
						'div',
						{ className: "message string " + (inline ? "inline" : '') },
						React.createElement(
							'span',
							null,
							'"'
				...
				case 'number':
					return React.createElement(
						'div',
						{ className: "message number " + (inline ? "inline" : '') },
						val.toString()
					);
					break;
				...
				case 'function':
					return React.createElement(
						'div',
						{ className: "message function " + (inline ? "inline" : '') },
						val.toString()
					);
					break;
				...
				case 'boolean':
					return React.createElement(
						'div',
						{ className: "message boolean " + (inline ? "inline" : '') },
						val.toString()
					);

				case 'object':
					var properties = [];
					var type = val.length ? 'Array' : 'Object';
					Object.keys(val).forEach(function (key) {
						var inline = true;
						if (_typeof(val[key]) == 'object') {
							inline = false;
						}
						properties.push(React.createElement(
							'div',
							{ key: key, className: 'clearfix' },
							React.createElement(
								'span',
								{ className: 'key' },
								key,
							...
							React.createElement(Message, { value: val[key], inline: true })
						));
					});
					return React.createElement(
						'div',
						{ className: "message object " + (inline !== false ? "inline" : '') },
						React.createElement(
							'div',
							{ className: 'obj-title', onClick: this.objToggle },
							React.createElement(
								'span',
								{ className: 'obj' },
								type
							...
							React.createElement(
								'span',
								{ className: "foldCtrl " + (this.state.fold ? "ctrl-fold" : "ctrl-unfold") },
								'>'
							)
						),
						React.createElement(
							'div',
							{ className: "inner " + (this.state.fold ? "fold" : "unfold") },
							properties
						)
					);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".__debugger__ { position: relative; z-index: 100000;} .__debugger__ .wrap {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  padding: 10px 30px 30px 30px;\n  -webkit-box-sizing: border-box;\n     -moz-box-sizing: border-box;\n          box-sizing: border-box;\n  height: 400px;\n  background: rgba(36, 36, 36, 0.8);\n  color: #cdcdcd;\n  font-family: \"Microsoft Yahei\";\n  font-size: 12px;\n  overflow-y: scroll;\n  overflow-x: scroll;\n  -webkit-overflow-scrolling: touch;\n}\n.__debugger__ .wrap .hide,\n.__debugger__ .wrap .fold {\n  display: none;\n}\n.__debugger__ .wrap .show,\n.__debugger__ .wrap .unfold {\n  display: block;\n}\n.__debugger__ .wrap .foldCtrl {\n  -webkit-transition: .3s;\n  transition: .3s;\n  display: inline-block;\n}\n.__debugger__ .wrap .inline {\n  display: inline-block;\n}\n.__debugger__ .wrap .ctrl-fold {\n  -webkit-transform: rotate(0deg);\n      -ms-transform: rotate(0deg);\n          transform: rotate(0deg);\n}\n.__debugger__ .wrap .ctrl-unfold {\n  -webkit-transform: rotate(90deg);\n      -ms-transform: rotate(90deg);\n          transform: rotate(90deg);\n}\n.__debugger__ .wrap .close {\n  position: fixed;\n  right: 30px;\n  top: 10px;\n  color: #fff;\n}\n.__debugger__ .wrap .message {\n  padding: 0;\n}\n.__debugger__ .wrap .string .str {\n  color: #F23C38;\n}\n.__debugger__ .wrap .number,\n.__debugger__ .wrap .boolean {\n  color: #977dfc;\n}\n.__debugger__ .wrap .object .obj {\n  font-style: italic;\n  padding-right: 15px;\n}\n.__debugger__ .wrap .inner {\n  padding-left: 20px;\n}\n.__debugger__ .wrap .key {\n  float: left;\n  padding: 3px 0;\n}\n.__debugger__ .wrap .clearfix {\n  overflow: hidden;\n}\n.__debugger__ .wrap .clearfix:after {\n  clear: both;\n  content: \"\";\n  width: 0;\n  height: 0;\n}\n.__debugger__ .wrap .obj-title {\n  cursor: pointer;\n}\n.__debugger__ .wrap .input {\n  position: fixed;\n  top: 170px;\n}\n.__debugger__ .wrap .input input {\n  background: transparent;\n  border: none;\n  border-bottom: 1px solid #fff;\n  color: #fff;\n  outline: none;\n}\n.__debugger__ .wrap .input input:before {\n  content: \"\";\n  width: 10px;\n  height: auto;\n  display: block;\n}\n.__debugger__ .wrap .input button {\n  background: #d1d1d1;\n  color: #000;\n  border: none;\n  -webkit-border-radius: 3px;\n          border-radius: 3px;\n  outline: none;\n}\n.__debugger__ .expand {\n  position: fixed;\n  right: 30px;\n  top: 10px;\n  width: 20px;\n  height: 20px;\n  background: rgba(36, 36, 36, 0.8);\n  color: #fff;\n  text-align: center;\n  -webkit-border-radius: 7px;\n          border-radius: 7px;\n}\n", ""]);
